...
class WishlistController {
      ...
      public static async addToWishlist(req: AuthRequest, res: Response) {
      ...
      public static async fetchWishlist(req: AuthRequest, res: Response) {
            const userId = req.user?.id;
            if (!userId) {
                  return res.status(401).json({ 
                        message: "Unauthorized", 
      ...
      public static async removeFromWishlist(req: AuthRequest, res: Response) {
            const userId = req.user?.id;
            if (!userId) {
                  return res.status(401).json({ 
                        message: "Unauthorized", 
