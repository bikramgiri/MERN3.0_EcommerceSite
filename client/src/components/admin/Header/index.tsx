...
const Header: React.FC<HeaderProps> = ({ onClick, onToggle }) => {
  ...
  return (
    <header className="sticky top-0 flex w-full bg-white border-gray-200 z-99999 border-gray-400 dark:bg-gray-900">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border border-gray-200 dark:border-gray-400 sm:gap-4 lg:justify-normal lg:px-0 lg:py-4">
          <button
