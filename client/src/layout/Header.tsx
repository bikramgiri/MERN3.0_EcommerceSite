...
import SearchProducts from "../global/components/header/SearchProducts";
import Notifications from "../global/components/header/Notifications";
import UserDropdown from "../global/components/header/UserDropdown";
