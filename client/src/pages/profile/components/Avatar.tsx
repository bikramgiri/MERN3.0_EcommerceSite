    ...
    <section className="font-['Inter',sans-serif]">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-4">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-xs text-[#1A1613]/50">JPG, JPEG or PNG. 1MB max.</p>
          {errors.avatar && <p className="text-xs text-[#8B2E1F]">{errors.avatar}</p>}
          {errors.general && <p className="text-xs text-[#8B2E1F]">{errors.general}</p>}
        </div>
      </div>
    </section>
  );
